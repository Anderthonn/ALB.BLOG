...
namespace ALB.BLOG.DOMAIN.Models
{
    ...
    public class Page
    {
        ...
        #region Constructor
        public Page(int id, string title, string shortDescription, string description, string slug, string thumbnailUrl)
        {
            Id = id;
            Title = title;
        ...
        public Page(string title, string shortDescription, string description, string slug, string thumbnailUrl)
        {
            Title = title;
            ShortDescription = shortDescription;
            Description = description;
